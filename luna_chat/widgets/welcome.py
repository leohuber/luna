...
[@click='open_repo'][b r]https://github.com/darrenburns/luna[/][/]
"""

    BORDER_TITLE = "Welcome to Luna!"
    ...
    def _action_open_repo(self) -> None:
        ...
        webbrowser.open("https://github.com/darrenburns/luna")

    def _action_open_issues(self) -> None:
        import webbrowser

        webbrowser.open("https://github.com/darrenburns/luna/issues")
