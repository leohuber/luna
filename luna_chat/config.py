...
class LunaChatModel(BaseModel):
    ...
    """A description of the model which may appear inside the Luna UI."""
...
def get_builtin_openai_models() -> list[LunaChatModel]:
    return [
        LunaChatModel(
            id="luna-gpt-3.5-turbo",
            name="gpt-3.5-turbo",
...
def get_builtin_anthropic_models() -> list[LunaChatModel]:
    return [
        LunaChatModel(
            id="luna-claude-3-5-sonnet-20240620",
        ...
        LunaChatModel(
            id="luna-claude-3-haiku-20240307",
        ...
        LunaChatModel(
            id="luna-claude-3-sonnet-20240229",
        ...
        LunaChatModel(
            id="luna-claude-3-opus-20240229",
...
def get_builtin_google_models() -> list[LunaChatModel]:
    return [
        LunaChatModel(
            id="luna-gemini/gemini-1.5-pro-latest",
...
def get_builtin_models() -> list[LunaChatModel]:
...
class LaunchConfig(BaseModel):
    ...
    # This makes this LaunchConfig instance immutable.
    model_config = ConfigDict(frozen=True)

    default_model: str = Field(default="luna-gpt-4o")
    """The ID or name of the default model."""
    system_prompt: str = Field(default=os.getenv("LUNA_SYSTEM_PROMPT", "You are a helpful assistant named Luna."))
    """The default Pygments syntax highlighting theme to be used in chatboxes."""
    models: list[LunaChatModel] = Field(default_factory=list)
    builtin_models: list[LunaChatModel] = Field(default_factory=get_builtin_models, init=False)

    @property
    def all_models(self) -> list[LunaChatModel]:
        return self.models + self.builtin_models

    @property
    def default_model_object(self) -> LunaChatModel:
