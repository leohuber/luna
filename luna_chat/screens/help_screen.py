...
If focus is on the prompt input box on the home screen, `esc` will close Luna too.
...
* https://github.com/darrenburns/luna/blob/main/README.md
...
Luna has very strong mouse support. Most things can be clicked.
...
"""
    ...
    def compose(self) -> ComposeResult:
        with Vertical(id="help-container") as vertical:
            vertical.border_title = "Luna Help"
            with VerticalScroll():
